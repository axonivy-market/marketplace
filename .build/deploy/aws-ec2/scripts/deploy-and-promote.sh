...
ssh "${SSH_OPTS[@]}" "${SSH_USER}@${NODE_IP}" \
    "RELEASE_VERSION='${RELEASE_VERSION}' NODE_NUMBER='${NODE_NUMBER}' HEALTH_CHECK_TARGETS='${HEALTH_CHECK_TARGETS_ARG}' CREDS_TEMP_FILE='${CREDS_TEMP_FILE}' HEALTH_CHECK_TIMEOUT='${HEALTH_CHECK_TIMEOUT}' HEALTH_CHECK_INTERVAL='${HEALTH_CHECK_INTERVAL}' bash -se" <<'REMOTE_EOF'
