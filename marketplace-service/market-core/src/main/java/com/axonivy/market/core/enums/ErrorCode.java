...
public enum ErrorCode {
  ...
  RELEASE_LETTER_NOT_FOUND("1108", "RELEASE_LETTER_NOT_FOUND"), RELEASE_LETTER_RELEASE_VERSION_ALREADY_EXISTED("1109",
      "RELEASE_LETTER_OF_THIS_VERSION_ALREADY_EXISTED"), SPRINT_CANNOT_BE_BLANK("1110",
