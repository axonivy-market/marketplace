...
import static com.axonivy.market.core.constants.CoreEntityConstants.MAVEN_ARTIFACT_VERSION;
...
public class MavenArtifactVersion extends AbstractAuditableEntity<MavenArtifactKey> {
  ...
  @Schema(description = "Artifact download url",
      example = "https://maven.axonivy.com/com/axonivy/connector/adobe/acrobat/sign/adobe-acrobat-sign-connector/" +
          "10.0.25/adobe-acrobat-sign-connector-10.0.25.iar")
