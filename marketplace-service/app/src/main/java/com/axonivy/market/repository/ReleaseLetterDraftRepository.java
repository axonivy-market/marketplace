...
public interface ReleaseLetterDraftRepository extends JpaRepository<ReleaseLetterDraft, String> {
  Optional<ReleaseLetterDraft> findByGitHubUserIdAndReleaseLetterId(String githubUserId, String releaseLetterId);

  void deleteByReleaseLetterId(String releaseLetterId);

  @Modifying
  void deleteByGitHubUserIdAndReleaseLetterId(String gitHubUserId, String releaseLetterId);
}
