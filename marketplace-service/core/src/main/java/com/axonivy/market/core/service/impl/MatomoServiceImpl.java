...
public class MatomoServiceImpl implements MatomoService {
  ...
  public MatomoServiceImpl(
      MatomoTrackerBuilder matomoTrackerBuilder) {this.matomoTrackerBuilder = matomoTrackerBuilder;}
  ...
  public void trackEventAsync(HttpServletRequest httpServletRequest) {
    ...
    String referrerUrl = httpServletRequest.getHeader(CoreCommonConstants.REFERER);
    ...
    MatomoRequest req = MatomoRequests.pageView(resolvePageViewName(requestUrl, referrerUrl))
        ...
        .headerUserAgent(httpServletRequest.getHeader(CoreCommonConstants.USER_AGENT))
  ...
  private Map<String, String> cloneRequestHeaders(HttpServletRequest httpServletRequest) {
    ...
    headers.put(CoreHttpHeaderConstants.X_FORWARDED_FOR, httpServletRequest.getRemoteAddr());
    headers.put(CoreHttpHeaderConstants.X_REAL_IP, httpServletRequest.getRemoteAddr());
    return headers;
  }
  ...
  private String resolvePageViewName(String requestUrl, String referrerUrl) {
    ...
    if (requestUrl.contains(PRODUCT_DETAILS_PREFIX)) {
      ...
      return prefix + CoreCommonConstants.SPACE_SEPARATOR + productId;
    }
    return prefix + CoreCommonConstants.SPACE_SEPARATOR + NEO_PRODUCT_DASHBOARD;
  }
  ...
  private String extractProductId(String url) {
    ...
    return after.split(CoreCommonConstants.SLASH)[0];
  }
}
