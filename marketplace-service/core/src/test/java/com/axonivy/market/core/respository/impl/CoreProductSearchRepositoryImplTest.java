...
public class CoreProductSearchRepositoryImplTest extends CoreBaseSetup {

  Page<Product> mockResultReturn;
  ProductSearchCriteria searchCriteria;

  @Mock
  CoreProductCustomSortRepository coreProductCustomSortRepo;
  ...
  @InjectMocks
  CoreCustomProductRepositoryImpl coreProductListedRepository;

  @BeforeEach
  void setup() {
    searchCriteria = new ProductSearchCriteria();
    mockResultReturn = createPageProductsMock();
    ReflectionTestUtils.setField(coreProductListedRepository, "entityManager", em);
  }
  ...
  void testSearchByCriteria() {
    ...
    when(coreProductListedRepository.buildCriteriaSearch(searchCriteria, cb, productRoot)).thenReturn(predicate);
    ...
    when(coreProductListedRepository.buildCriteriaSearch(searchCriteria, cb, countRoot)).thenReturn(predicate);
    ...
    Page<Product> result = coreProductListedRepository.searchByCriteria(searchCriteria, PAGEABLE_ALPHABETICALLY);
  ...
  void testSearchByCriteriaOrderByStandard() {
    ...
    Page<Product> result = coreProductListedRepository.searchByCriteria(searchCriteria, PAGEABLE_STANDARD);
  ...
  void testFindByCriteria() {
    ...
    Product result = coreProductListedRepository.findByCriteria(searchCriteria);
    ...
    result = coreProductListedRepository.findByCriteria(searchCriteria);
    assertNotNull(result, "Result is empty");
  ...
  void testGetProductByIdAndVersion() {
    ...
    Product result = coreProductListedRepository.getProductByIdAndVersion(mockProduct.getId(),
        mockProduct.getVersion());
