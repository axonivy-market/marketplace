...
public class RequestMappingConstants {
  ...
  public static final String VERSION_DOWNLOAD_BY_ID = "/download/{id}/{artifactId}/{version}";
  ...
  public static final String ARTIFACTS_AS_ZIP = "/download/zip-file/{id}/{artifactId}/{version}";
