...
public class ChatService {
  ...
  private static final String SYSTEM_PROMPT = """
      ...
      **Instructions:**
      ...
      - Use **clear headings**, **bullet points**, **bold text**, and **links** when appropriate,font is under h4, no need images.
  ...
  public String getChatResponse(String userMessage) {
    try {
      ...
      ChatCompletionsOptions options = getChatCompletionsOptions(buildEnhancedPrompt(searchContext), userMessage);
