...
@Log4j2
@Component
public class MatomoStableTrackerBuilder extends MatomoTrackerBuilder {

  public MatomoStableTrackerBuilder(AppSettingService appSettingService) {
