...
describe('ProductDetailInformationTabComponent', () => {
  ...
  describe('getShieldsBadgeUrl', () => {
    ...
    it('should return empty string if sourceUrl is missing', () => {
      component.productDetail = { id: 'repo', sourceUrl: '' } as ProductDetail;
      expect(component.getShieldsBadgeUrl()).toBe('');
    });
    ...
    it('should return correct Shields.io badge URL for valid productDetail', () => {
      component.productDetail = {
        id: 'repo',
        sourceUrl: 'https://github.com/axonivy-market/repo'
      } as ProductDetail;
      expect(component.getShieldsBadgeUrl()).toBe(
        'https://img.shields.io/github/actions/workflow/status/axonivy-market/repo/ci.yml?branch=master'
      );
    });
  });
});
