...
describe('ProductService', () => {
  ...
  it('sendRequestToGetProductVersionForDesigner', () => {
    ...
    service.sendRequestToGetProductVersionsForDesigner(productId, designerVersion, false).subscribe(response => {
    ...
    const req = httpMock.expectOne(`api/product-details/${productId}/designerversions?designerVersion=${designerVersion}&isShowDevVersion=false`);
    expect(req.request.method).toBe('GET');
    expect(req.request.headers.get('X-Requested-By')).toBe('ivy');
