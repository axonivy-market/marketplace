...
//
// import { DeprecateSuccessDialogComponent } from './deprecation-result-dialog.component';
//
// describe('DeprecateSuccessDialogComponent', () => {
//   let component: DeprecateSuccessDialogComponent;
//   let fixture: ComponentFixture<DeprecateSuccessDialogComponent>;
//
//   beforeEach(async () => {
//     await TestBed.configureTestingModule({
//       imports: [DeprecateSuccessDialogComponent, TranslateModule.forRoot()]
//     }).compileComponents();
//
//     fixture = TestBed.createComponent(DeprecateSuccessDialogComponent);
