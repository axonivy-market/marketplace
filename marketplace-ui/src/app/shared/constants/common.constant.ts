...
export const DEFAULT_INSTALL_TOOLTIP =
...
export const DEPRECATED_INSTALL_TOOLTIP = "<p class='text-primary'>Installing deprecated extensions is not recommended. Use at your own discretion.</p>";
